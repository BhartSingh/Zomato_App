...
const Brand = () => {
  return (
    <div>
      <div className="mx-72  pt-10 text-4xl">Top brands for you</div>
      <div className="flex mx-64">
        <div className="p-5">
          ...
          <div className="my-2">
            ...
            <p className="text-md mx-10 text-gray-600 cursor-pointer">27 min</p>
          </div>
        </div>
        <div className="p-5">
          <div className=" shadow-xl  rounded-full">
          ...
          <div className="my-2">
            <span className="text-lg mx-3 text-gray-800 cursor-pointer">
              Domino's Pizza
            </span>
            <p className="text-md mx-10 text-gray-600 cursor-pointer">35 min</p>
          </div>
        </div>
        <div className="p-5">
          ...
          <div className="my-2">
            ...
            <p className="text-md mx-12 text-gray-600 cursor-pointer">30 min</p>
          </div>
        </div>
        <div className="p-5">
          <div className=" shadow-xl h-40 w-40 rounded-full">
          ...
          <div className="my-2">
            ...
            <p className="text-md mx-12 text-gray-600 cursor-pointer">25 min</p>
          </div>
        </div>
        <div className="p-5">
          ...
          <div className="my-2">
            ...
            <p className="text-md mx-12 text-gray-600 cursor-pointer">28 min</p>
          </div>
        </div>
        ...
        <div className="p-5">
          ...
          <div className="my-2">
            <span className="text-lg mx-6 text-gray-800 cursor-pointer">
              Burger King
            </span>
            <p className="text-md mx-12 text-gray-600 cursor-pointer">34 min</p>
          </div>
        </div>
      </div>
    </div>
