  ...
  return (
    <div className="mx-64 ">
      <div className=" flex mx-3 my-7 cursor-pointer ">
        ...
        <div className="p-3">
          <div className="bg-white text-gray-500 border-solid border-2 border-gray-300 h-7 w-full rounded-md flex ">
            <div className="my-1 font-bold mx-1">
              <GiPathDistance />
            </div>
            <h3 className="mx-2">Distance</h3>
          </div>
        </div>
        <div className="p-3">
          <div className="bg-white text-gray-500 border-solid border-2 border-gray-300 h-7 w-full rounded-md ">
        ...
        <div className="p-3">
          <div className="bg-white text-gray-500 border-solid border-2 border-gray-300 h-7 w-full rounded-md ">
            <h4 className="mx-2">Pubs & Bars</h4>
          </div>
        </div>
      </div>
    </div>
